...
AABSection::AABSection()
{
	...
	FString AssetPath = TEXT("/Script/Engine.StaticMesh'/Game/ArenaBattle/StaticMesh/SM_SQUARE.SM_SQUARE'");
	...
	FString GateAssetPath = TEXT("/Script/Engine.StaticMesh'/Game/ArenaBattle/StaticMesh/SM_GATE.SM_GATE'");
